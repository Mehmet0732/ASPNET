<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KayitOl.aspx.cs" Inherits="OkulKayit.KayitOl" %>
                ...
                <div class="nav_w3ls ml-lg-5">
                    <nav>
                        ...
                        <ul class="menu">
                            ...
                            <li><a href="Index.aspx">Bize Katıl</a></li>
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li><a href="Index.aspx" class="drop-text">Neler Yaptık?</a></li>
                                    <li><a href="Index.aspx" class="drop-text">Popüler Kurslar</a></li>
                                    <li><a href="Index.aspx" class="drop-text">İstatislik</a></li>
                                    <li><a href="Index.aspx" class="drop-text">Galeri</a></li>
                                </ul>
                            </li>
                            <li><a href="Index.aspx">İletişim</a></li>
            ...
            <div class="modal-body mt-md-2 mt-5">
                ...
                <form action="#" method="post" runat="server">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control"  placeholder="Mail Adresiniz..."></asp:TextBox>
                    </div>
                    <div class="form-group">
