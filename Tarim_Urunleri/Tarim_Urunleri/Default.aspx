<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Tarim_Urunleri.Default" %>
            ...
            <div class="container-fluid px-lg-4">
                <nav class="py-4">
                    <div class="logo" id="logo">
                        <a href="index.html">Tarım Projesi</a>
                    ...
                    <ul class="menu mt-md-3">
                        ...
                        <li class="mr-lg-2"><a href="#services" class="scroll">Hizmetelr</a></li>
            ...
            <ItemTemplate>
                <div class="container py-lg-5">
                    <div class="text-center">
                        <h2 class="w3_head">Hakkımızda </h2>
